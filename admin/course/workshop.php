...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card" >
            ...
            <a href="insert_workshop.php" class="btn btn-success">Add +</a>
            </div>
            <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="table1" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $query_program = "SELECT * FROM program WHERE ID_KATEGORI = 'WS'";
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="detail_workshop.php?id=<?php echo $data_program['ID_PROGRAM']; ?>" class="btn btn-primary">Detail</a>
                            </td>
                            <td>
                            <a href="edit_workshop.php?id=<?php echo $data_program['ID_PROGRAM']; ?>" class="btn btn-warning">Edit</a>
                            </td>
                            <td>
