...
<div class="page-heading">
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" >Insert New Workshop Class</h4>
                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first-name-vertical" class="form-control"
                                                    name="individu" placeholder="Harga Individu (sebelum PPN)" >
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first-name-vertical" class="form-control"
                                                    name="kolektif" placeholder="Harga Kolektif (sebelum PPN)" >
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="first-name-vertical" class="form-control"
                                                    name="korporat" placeholder="Harga Korporat (sebelum PPN)" >
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
    ...
    <?php
                ...
                $program        = mysqli_query($mysqli,"INSERT INTO program (ID_PROGRAM, ID_KATEGORI, NAMA_PROGRAM, INDIVIDU, KOLEKTIF, KORPORAT,PPN, DESKRIPSI, SESI, IMAGE)
                                                     VALUES ('$id_program', 'WS', '$nama_program', '$individu_ppn', '$kolektif_ppn', '$korporat_ppn', '$ppn', '$deskripsi', '$sesi','$gambar')");
