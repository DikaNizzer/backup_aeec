    ...
    echo "<script>location='../dashboard/regular.php';</script>";
        ...
        if(mysqli_num_rows($client) > 0){ 
            ...
            if($jenisDaftar == 2){
                ...
                // Kalau Non Kolektif
                echo "<script> 
                document.location.href = 'workshop_confirm.php?idprog=$id&idbatch=$idbatch&jenisDaftar=$jenisDaftar';
                </script>";
            }
            ...
            echo "<script> 
            document.location.href = 'workshop_form.php?idprog=$id&idbatch=$idbatch&jenisDaftar=$jenisDaftar';
            </script>";
        }
}
