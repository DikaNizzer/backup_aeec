                            ...
                            <form class="form form-vertical " method="post" action=""  enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="first-name-vertical">Alamat Sertifikat Pengiriman</label>
                                                <input type="text" id="first-name-vertical" class="form-control"
                                                    name="alamat_rumah" placeholder="Alamat Sertifikat Pengiriman" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <p style="color:red"><i>Pastikan NPWP yang anda masukkan adalah npwp pribadi atau perusahaan</i></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <p style="color:red"><i>Pastikan Alamat NPWP yang anda masukkan adalah npwp perusahaan anda</i></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
