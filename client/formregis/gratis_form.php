                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <p style="color:red"><i>Pastikan NPWP yang anda masukkan adalah npwp pribadi</i></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <p style="color:red"><i>Pastikan Alamat NPWP yang anda masukkan adalah alamat npwp pribadi anda</i></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
...
<?php
        ...
        if(isset($_POST['tambah'])){
            ...
            echo "<script>location='gratis_daftar.php?idprog=$id&idbatch=$idbatch';</script>";
