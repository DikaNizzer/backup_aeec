...
if (isset($_POST["ganti"])) {
    ...
    if (mysqli_affected_rows($koneksi) > 0){
        echo "<script> 
                ...
                document.location.href = 'workshop_upload_excel.php?idprog=$idprog&idbatch=$idbatch';
            </script>";
    }else{
        echo "<script> 
        ...
        for ($i = 2; $i <= $sheetCount; $i ++) {
            ...
            if ($name!=null & $email!=null) {
                ...
                if($result = true){
                    ...
                    echo"<script>location='workshop_tampil_excel.php?idprog=$idprog&idbatch=$idbatch&jenis=$type&pesan=$message&jumlah=$jumlahInput'</script>";
                } else {
                    $type = "error";
