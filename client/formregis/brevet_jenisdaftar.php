                                        ...
                                        <div class="col-md-4 px-0">
                                            <div class="card">
                                                ...
                                                <div class="card-footer">
                                                    <a href="brevet_cekForm.php?idprog=<?=$hasil['ID_PROGRAM']?>&idbatch=<?=$_GET['idbatch'] ?>&jenisDaftar=2"><button class="btn btn-primary btn-block">Daftar</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 px-0">
                                            <div class="card card-highlighted">
                                                ...
                                                <div class="card-footer">
                                                    <a href="brevet_cekForm.php?idprog=<?=$hasil['ID_PROGRAM']?>&idbatch=<?=$_GET['idbatch'] ?>&jenisDaftar=1"><button class="btn btn-outline-white btn-block">Daftar</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 px-0">
                                            <div class="card">
                                                ...
                                                <h1 class="price"><i class="bi bi-mortarboard"></i></h1>
                                                <br><br>
                                                <div class="card-footer">
                                                    <a href="brevet_cekForm.php?idprog=<?=$hasil['ID_PROGRAM']?>&idbatch=<?=$_GET['idbatch'] ?>&jenisDaftar=3"><button class="btn btn-primary btn-block">Daftar</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
