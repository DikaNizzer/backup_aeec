                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                ...
                                <p class="text-subtitle text-muted">Program Workshop yang sedang aktif</p>
                            </div>
    ...
    ?>
                <div class="mb-3 col-md-8 col-lg-3">
                  <div class="border rounded h-100 d-flex flex-column justify-content-between pb-3">
                    ...
                    <a href="../formregis/workshop_jenisdaftar.php?idprog=<?=$spare['ID_PROGRAM'] ?>&idbatch=<?=$spare['ID_BATCH'] ?>" class="btn btn-primary daftar">DAFTAR</a>
                  </div>
                </div>
      <?php }?>
              </div>
